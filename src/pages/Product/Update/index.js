...
import { getProduct, updateProduct } from "../../../redux/action/product";
    ...
    authentication()
      .then(() => {
        getProduct(id).then((res) => {
          ...
          setNeedId(res.data.needId);
          setFamilyId(res.data.familyId);
          setName(res.data.name);
          setDescription(res.data.description);

          getFamilies(res.data.needId).then((res) => {
            dispatch({
              type: "GET_FAMILIES",
              payload: res.data,
            });
